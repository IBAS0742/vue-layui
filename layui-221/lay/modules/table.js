    ...
    A.prototype.config = {
        ...
        A.prototype.render = function() {
            ...
            if (a.elem = t(a.elem),
                    ...
                    a.dearwith = a.dearwith || function () {},
                    a.ajaxoption ? t.ajaxSetup(a.ajaxoption) : '',
                    a.request = t.extend({
                        pageName: "page",
                        limitName: "limit"
                    }, a.request),
        ...
        A.prototype.setArea = function() {
            ...
            t.height && /^full-\d+$/.test(t.height) && (e.fullHeightGap = t.height.split("-")[1],
                t.height = H.height() - e.fullHeightGap)
        }
        ,
        ...
        d.checkStatus = function(e) {
            ...
            return a ? (layui.each(a, function(e, a) {
                a[d.config.checkName] && (t++,
                    i.push(d.clearCacheKey(a)))
            }),
                {
                    data: i,
                    isAll: t === a.length
